...
from transformer.quant_bert_modeling import TinyBertForSequenceClassification
...
def do_eval(model, task_name, eval_dataloader,
    ...
    for batch_ in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            logits, atts, states = model(input_ids, segment_ids, input_mask)
            # for hs in states:
            #     hs = hs.detach()
    ...
    print(preds.shape, eval_labels.shape)
    print(preds[:100], eval_labels[:100])
...
def main():
    ...
    # hack
    args.data_dir = os.path.join("glue_data", args.task_name)
    ...
    teacher_model = TinyBertForSequenceClassification.from_pretrained(args.teacher_model, hidden_act=args.hidden_act, softmax_act=args.softmax_act, num_labels=num_labels)
